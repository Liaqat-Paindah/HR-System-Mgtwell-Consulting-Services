                                ...
                                <div class="profile-view">
                                    <div class="profile-img-wrap">
                                        <div class="profile-img">
                                            <a href="#"><img alt="" src="{{ URL::to('/assets/images/'. $usercount->profile) }}" alt="{{ $usercount->name }}"></a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="profile-info-left">
                                                    ...
                                                    <div class="small doj text-muted">Date of Join : {{ $usercount->created_at }}</div>
                                                    <a href="{{ url('employee_pdf/'.$usercount->employee_id) }}" class="btn btn-outline-success btn-sm"> <i class="fa fa-print"></i> Print Details</a>
                                                </div>
                                            </div>
                                            <div class="col-md-7">
                                ...
                                <div class="col-sm-12">
                                    <div class="statistics-details d-flex align-items-center justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-success d-flex"><i class="mdi mdi-menu-up"></i><span>{{ $inactive_percentage }}%</span>
                                            </p>
                                        </div>
                                        <div>
                                            ...
                                            <div class="card card-rounded">
                                                <div class="card-body">
                                                    <div class="d-sm-flex justify-content-between align-items-start">
                                                        <div>
                                                            <h4 class="card-title card-title-dash">Monthly Leaves based on Employees</h4>
                                                            <p class="card-subtitle card-subtitle-dash">This report provides a detailed overview of employee leave patterns on a monthly basis, helping organizations track leave usage, manage workforce availability, and plan resources efficiently.</p>
                                                        </div>
                                                        <div>
                                                            <div class="dropdown">
                                                                <button
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <h4 class="card-title card-title-dash">Recent Leave list</h4>
                                                                ...
                                                                <ul class="todo-list todo-list-rounded">
                                                                    ...
                                                                    <li class="d-block">
                                                                        <div class="form-check w-100">
                                                                            <label class="form-check-label">
                                                                                ...
                                                                                Sayed Safarullah Pacha requested new annaul leave <i
                                                                    ...
                                                                    <li>
                                                                        <div class="form-check w-100">
                                                                            <label class="form-check-label">
                                                                                <input class="checkbox" type="checkbox">
                                                                                Waris Stanikzay recently requested new sick leave <i
                                                                                    class="input-helper rounded"></i>
                                                                            </label>
                                                                            <div class="d-flex mt-2">
                                                                    ...
                                                                    <li class="border-bottom-0">
                                                                        <div class="form-check w-100">
                                                                            <label class="form-check-label">
                                                                                <input class="checkbox" type="checkbox">
                                                                                Nawidullah Assadzay requested annual leave! <i
                                                                                    class="input-helper rounded"></i>
                                                                            </label>
                                                                            <div class="d-flex mt-2">
