	...
	<div class="main-wrapper">
		...
		<div class="header">
			...
			<div class="header-left">
				<a href="<?php echo e(route('home')); ?>" class="logo"> <img src="<?php echo e(URL::to('assets/img/logo.png')); ?>" width="100"
						alt=""></a>
			</div>
			<!-- /Logo -->
...
</html><?php /**PATH /home4/mgtwepsq/hrs.mgtwell.com/resources/views/layouts/master.blade.php ENDPATH**/ ?>