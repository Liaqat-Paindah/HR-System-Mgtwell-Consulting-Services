        ...
        <div id="edit_leave" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo e(route('form/leavesemployee/edit')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="modal-btn delete-action">
                            <form action="<?php echo e(route('form/leaves/edit/delete')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="admin_id" class="e_id" value="">
                                <div class="row">
                                    <div class="col-6">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ardho/hrs.ardho.org/resources/views/form/leavesemployee.blade.php ENDPATH**/ ?>