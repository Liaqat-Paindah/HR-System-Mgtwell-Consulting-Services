    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
             ...
             <li class="submenu">
                    <a href="<?php echo e(url('/attendance/employee/page')); ?>" ><i class="la la-edit"></i> <span> Attendances</span> <span
             ...
             <li class="submenu">
               ...
               <li class="submenu">
                ...
                <?php elseif(Auth::user()->role_name=='Procurement'): ?>
             <li>
                    <a href="<?php echo e(url('/home')); ?>"><i class="la la-dashboard"></i> <span>Dashboard</span></a>
            </li>
...
<!-- /Sidebar -->
<?php /**PATH /home/ardho/hrs.ardho.org/resources/views/sidebar/menubar.blade.php ENDPATH**/ ?>