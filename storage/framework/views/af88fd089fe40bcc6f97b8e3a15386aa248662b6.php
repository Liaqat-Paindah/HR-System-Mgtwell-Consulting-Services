...
<?php echo $__env->make('sidebar.menubar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <!-- Search Filter -->
            <form action="<?php echo e(route('search/user/list')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($user->role_name=='Admin'): ?>
                                            ...
                                            <?php elseif($user->role_name=='Procurement'): ?>
                                            <span data-toggle="modal" data-id="<?php echo e($user->rec_id); ?>" data-target="#approve_leave" class="badge bg-inverse-success role_name"><?php echo e($user->role_name); ?></span>
                                        ...
                                        <div class="dropdown action-label">
                                            <?php if($user->status=='Active'): ?>
                                                <a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
                                                    ...
                                                    <span class="statuss"><?php echo e($user->status); ?></span>
                                                </a>
                                                <?php else: ?>
                                                <a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form action="<?php echo e(route('form/user/confirm')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ardho/hrs.ardho.org/resources/views/usermanagement/user_control.blade.php ENDPATH**/ ?>