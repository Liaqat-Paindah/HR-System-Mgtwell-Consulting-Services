...
<?php echo $__env->make('sidebar.menubar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <div class="page-wrapper">
                ...
                <?php if(Auth::user()->role_name=='Employee' || Auth::user()->role_name=='Manager' || Auth::user()->role_name=='Finance' || Auth::user()->role_name=='Procurement'): ?>
                <div class="row">
                <div class="col-md-12">
                ...
                <div class="d-flex justify-content-between mb-3">
                <div>
                <span class="d-block">Pending Expenses</span>
                </div>
                <div>
                <span class="text-success"><?php echo e($expensesstaff); ?></span>
                </div>
                </div>
                <h4 class="mb-3"><?php echo e($Purchased); ?> Purchased Items</h4>
                <div class="progress mb-2" style="height: 5px;">
                <div class="progress-bar bg-primary" role="progressbar" style="width: 70%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="personal-info">
                                            ...
                                            <tr>
                                                ...
                                                <td class="dt-contents"><?php echo e($usercount->tin); ?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="dt-contents"><?php echo e($usercount->address); ?></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="personal-info">
                                            <tr>
                                                ...
                                                <td class="dt-contents"><?php echo e($usercount->category); ?></td>
                                            </tr>
                                            <tr>
                                                <th class="dt-details">Step:</th>
                                                <td class="dt-contents"><?php echo e($usercount->step); ?></td>
                                            </tr>
                                            <tr>
                ...
                <div class="row">
                    ...
                    <a href="invoices.html">View all leaves</a>
                    </div>
                    </div>
                    </div>
                    <div class="col-md-6 d-flex">
                    ...
                    <div class="card-footer">
                    <a href="payments.html">View all Attendances</a>
                    </div>
                    </div>
                    </div>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ardho/hrs.ardho.org/resources/views/dashboard/dashboard.blade.php ENDPATH**/ ?>