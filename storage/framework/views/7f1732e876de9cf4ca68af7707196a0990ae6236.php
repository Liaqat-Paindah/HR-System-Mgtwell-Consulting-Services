            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="stats-info">
                        ...
                        <h4><?php echo e($sum_approved); ?></h4>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stats-info">
                        <h6>Total Declined</h6>
                        <h4><?php echo e($sum_Declined); ?></h4>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stats-info">
                        <h6>Confirmed By Director</h6>
                        <h4><?php echo e($sum_Confirmed); ?></h4>
                    </div>
                </div>
            </div>
            <!-- /Leave Statistics -->
                        ...
                        <table class="table table-striped custom-table mb-0 datatable">
                            ...
                            <tbody>
                                <?php if(!empty($leaves4)): ?>
                                    <?php $__currentLoopData = $leaves4; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($items->status === 'Approved' || $items->status === 'Confirmed'): ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown action-label">
                                                    <a class="dropdown-item leave_now" data-toggle="modal" data-id="<?php echo e($items->id); ?>" data-target="#approve_leave"><i class="fa fa-dot-circle-o text-purple"></i> <?php echo e($items->status); ?></a>
                                ...
                                <?php if(!empty($leaves4)): ?>
                                    <?php $__currentLoopData = $leaves4; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="leave_type"><?php echo e($items->leave_category); ?></td>
                                            <td hidden class="from_date"><?php echo e($items->from_date); ?></td>
                                            <td><?php echo e(date('d F, Y',strtotime($items->from_date))); ?></td>
                                            <td hidden class="to_date"><?php echo e($items->to_date); ?></td>
                                            <td><?php echo e(date('d F, Y',strtotime($items->to_date))); ?></td>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post"  enctype="multipart/form-data" action="<?php echo e(route('form/leaves/save')); ?>" >
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
                                ...
                                <select class="select"  name="leave_category">
                                    ...
                                    <option value="Haj Leave " >Haj Leave </option>
        ...
        <div id="edit_leave" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo e(route('form/leaves/edit')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <form action="<?php echo e(route('leave.approve')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="modal-btn delete-action">
                            <form action="<?php echo e(route('form/leavesadmin/edit/delete')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ardho/hrs.ardho.org/resources/views/form/leaves.blade.php ENDPATH**/ ?>